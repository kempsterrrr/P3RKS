        ...
        <div className="flex space-x-[60px] lg:mt-[109px]">
          <div className="flex-1 space-y-[30px] lg:space-y-[60px]">
            ...
            <div className="space-y-[20px]">
              ...
              <div className="m-1 rounded-[16px] overflow-hidden border-[1px] border-[#F3F1F3] dark:border-[#2E2E2E]">
                <Carousel
                  showArrows={false}
              ...
              <div>
                <a
                  className="lg:hidden fixed bottom-[20px] w-[90%] flex justify-center text-white text-[15px] font-medium rounded-full bg-[#1A021B] py-[18px] px-[48px] cursor-pointer sm:text-[16px] lg:text-[18px] lg:px-[52px] transition duration-150 hover:ease-in-out hover:shadow-[0_0_35px_rgba(0,0,0,0.25)] dark:border-[#414141] dark:bg-[#EAEAEA] dark:text-[#171717] dark:hover:bg-white"
                  onClick={() =>
                    handleRedeemPerk(
                      perk?.id,
                      perk?.fields["Uses"],
